...
Blacklisted: ${util.phoneList(config.blacklist, contact)}
Mute: ${util.phoneList(config.mutelist, contact)}
Trusted: ${util.phoneList(config.trustlist, contact)}
Vips: ${util.phoneList(config.vips, contact)}`
    );
